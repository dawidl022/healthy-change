instructions = ["Uwaga! Wszystkie statystyki i podpowiedzi są tylko przybliżeniem.", "Zalecamy kierować się zdrowym"
                ...
                "Na gorze ekranu widnieje barwny wskaźnik BMI z twoją wartością BMI", "Niebieski kolor: Niedowaga",
                ...
                "Kliknij odpowiedni przycisk w \"Usatwieniach\"", "", "3. Bilans Kaloryczny",
                ...
                "Szczególnie podczas oraz po wysiłku fizycznym!", "", "5. Pełne statystiki dnia", "Tutaj znajdziesz sumaryczne podsumowanie swojego dnia",
                "Wyświetlane są statystyki dotyczące wysiłku fizycznego, spożytej wody", "A takze każdego poszczególnego składnika spożywczego spożytego w ciągu dnia.",
                "", "6. Sprawdź produkt", "Tutaj możesz wyszukać praktycnie dowolny produkt spożywczy, stosując się do podanej skłądni wyszukania",
                ...
                "Jeśli spożyłeś ten produkt, możesz śmiało dodać do \"spożytych dzisiaij posiłków\"", "",
                "7. Główny ekran", "Na środku ekranu będą się wyświetlaly wszystkie aktywnośći które dodasz w ciągu dnia.", "",
                "8. Dodawanie Aktywności", "Możesz dodawać aktywności takie jak wysiłek fizyczny, posiłku, oraz wypicie wody.",
                ...
                "Po wybranie samopoczucia, wyświetlamy Ci podpowiedzi na popołudnie lub na następny dzień"
                ]
...
def min_options():
    ...
    instructions.insert(23, "Aby zrzucić wagę, bilans orientacyjnie powinien się wynosić poniżej 0")


def stay_options():
    instructions.insert(21, "Aby zrzucić wagę, bilans orientacyjnie powinien się wynosić poniżej 0")
...
def max_options():
    ...
    instructions.insert(23, "Aby nabrać masę, bilans orientacyjnie powinien się wynosić powyżej 0")
